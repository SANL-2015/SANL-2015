...
echo
echo "set arrow from 60000,70 to 100,70 nohead lw 5 lt 1;"
echo "set label \"All other locks have collapsed (60000 cycles): 70%\"  at 110,75 font \"Helvetica,7.5\";"
echo
echo "set arrow from 120000,20 to 100,20 nohead lw 5 lt 1;"
echo "set label \"Collapse of POSIX (120000 cycles): 20%\"  at 110,25 font \"Helvetica,7.5\";"
echo
...
#echo ",\\"
#echo -n "     "
echo -n "\"results/left_contention_gl_posix_1_0_dependent.csv\" using 1:2 axes x1y2 with linespoint lw 5 pointsize 2 lc rgb \"#9bbb59\" lt 1 pt 12 title \"% of time in CS\""
