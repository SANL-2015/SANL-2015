...
struct thread_descriptor {
	...
	unsigned char tick_me[2];
	unsigned int isclient;
	unsigned int need_to_count;
};
...
struct id_manager {
	...
	unsigned int   volatile lock_num;
	unsigned int   volatile fragmented_num;
...
extern unsigned int      				  lock_thread_num;
